...
fzf_path=/nix/store/lnk0k7d364bldl9qknvkyja8pf0w05vb-fzf-0.59.0
...
if [ -x $fzf_path/bin/fzf ] && [ -x $fzf_path/bin/fzf-tmux ]; then
  ...
  # source "/nix/store/lnk0k7d364bldl9qknvkyja8pf0w05vb-fzf-0.59.0/share/fzf/completion.zsh"

  source "/nix/store/lnk0k7d364bldl9qknvkyja8pf0w05vb-fzf-0.59.0/share/fzf/key-bindings.zsh"
fi;
